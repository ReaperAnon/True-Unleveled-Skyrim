...
Fourthly, there is an option to "Morrowlootify" equipment. This means that all equipment in the current load order will receive stats they would have in Morrowloot, except without the compatibility and balancing nightmare it provides.
...
- **[Skill Based Damage and Magnitude Multipliers](https://www.nexusmods.com/skyrim/mods/21828/?):** Not as needed for the optimal experience as the others but it really helps make up for the lack of the fake extra damage perks. It has to be converted for SSE, but I consider it a nice addition.
